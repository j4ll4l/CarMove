...
function handleLogin() {
  ...
  if (password.value !== repeatPassword.value) {
    error.value = 'Les mot passe correspond pas'
    return
  }
  error.value = ''
  ...
  console.log('Répéter le mot de passe:', repeatPassword.value)
}
  ...
  <main>
    ...
    <div class="custom-card login-card">
      <div class="custom-card-body">
        <h5 class="custom-card-title">Inscription</h5>
